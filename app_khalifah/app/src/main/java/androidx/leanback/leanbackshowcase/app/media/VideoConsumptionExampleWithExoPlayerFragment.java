...
public class VideoConsumptionExampleWithExoPlayerFragment extends VideoFragment {
    ...
    Uri uri = RawResourceDataSource.buildRawResourceUri(R.raw.abu);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intentMetaData != null) {
            ...
            mMediaPlayerGlue.setTitle("Abu Bakar Ash-Shiddiq");
            mMediaPlayerGlue.setSubtitle("Abu Bakar (lahir: 572 - wafat: 23 Agustus 634/21 Jumadil Akhir 13 H)");
