...
import androidx.leanback.leanbackshowcase.app.details.AliViewActivity;
...
import androidx.leanback.leanbackshowcase.app.details.UmarViewActivity;
import androidx.leanback.leanbackshowcase.app.details.UtsmanViewActivity;
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
            ...
            switch (id) {
                ...
                case 1:
                    intent = new Intent(getActivity().getBaseContext(),
                            UmarViewActivity.class);
                    break;
                case 2: {
                    intent = new Intent(getActivity().getBaseContext(),
                            UtsmanViewActivity.class);
                    break;
                }
                case 3: {
                    intent = new Intent(getActivity().getBaseContext(),
                            AliViewActivity.class);
                    break;
                }
                case 4: {
                    intent = new Intent(getActivity().getBaseContext(),
