...
public class UmarViewFragment extends DetailsFragment implements OnItemViewClickedListener,
    ...
    private void setupUi() {
        ...
        String json = Utils
                .inputStreamToString(getResources().openRawResource(R.raw.umar_detail));
