...
import androidx.leanback.leanbackshowcase.app.media.UmarVideoExoActivity;
...
public class UtsmanViewFragment extends DetailsFragment implements OnItemViewClickedListener,
    ...
    private void setupUi() {
        ...
        String json = Utils
                .inputStreamToString(getResources().openRawResource(R.raw.utsman_detail));
