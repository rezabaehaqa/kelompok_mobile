...
public class UtsmanVideoFragment extends VideoFragment {
    ...
    Uri uri = RawResourceDataSource.buildRawResourceUri(R.raw.utsman);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intentMetaData != null) {
            ...
            mMediaPlayerGlue.setTitle("Utsman bin Affan");
            mMediaPlayerGlue.setSubtitle("Utsman bin Affan (574 – 656 / 12 Dzulhijjah 35 H; umur 81–82 tahun) ");
